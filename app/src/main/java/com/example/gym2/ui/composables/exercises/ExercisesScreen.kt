...
fun ExercisesScreen(
    ...
    Surface(
        ...
        Column(
            ...
            Heading(text = stringResource(id = R.string.exercises))
            ...
            Row(
                ...
                ExerciseItem(
                    image = R.drawable.chest_anatomy_nb,
                    bodyPart = stringResource(id = R.string.chest)) {
                    workoutViewModel.selectMuscleGroup(listOf(Muscle.Chest), "Chest")
                    navController.navigate(Screens.ExerciseDetails.route)
                }
                ExerciseItem(
                    image = R.drawable.deltoids_anatomy_nb,
                    bodyPart = stringResource(id = R.string.shoulders)) {
                ...
                ExerciseItem(
                    image = R.drawable.biceps_anatomy_nb,
                    bodyPart = stringResource(id = R.string.biceps)) {
            ...
            Row(
                ...
                ExerciseItem(image = R.drawable.triceps_anatomy_nb, bodyPart = stringResource(
                    R.string.triceps)) {
                    workoutViewModel.selectMuscleGroup(listOf(Muscle.Triceps), "Triceps")
                    navController.navigate(Screens.ExerciseDetails.route)
                }
                ExerciseItem(image = R.drawable.traps_anatomy_nb, bodyPart = stringResource(
                    R.string.upper_back)) {
                    workoutViewModel.selectMuscleGroup(listOf(Muscle.Traps), "Upper Back")
                    navController.navigate(Screens.ExerciseDetails.route)
                }
                ExerciseItem(image = R.drawable.lats_anatomy_nb, bodyPart = stringResource(
                    R.string.lats)) {
